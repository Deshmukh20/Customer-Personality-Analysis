...
cluster_descriptions = {
    0: {
        "title": "Younger Families with One Young Child",
        "messaging": "Emphasize products or services that support early childhood development, parenting hacks, and convenience.",
        "channels": "Social media platforms like Instagram and Facebook.",
        "promotions": "Bundle deals for family-friendly products. Time-sensitive discounts.",
        "content_ideas": "Share tips on balancing work and parenting. Create engaging content like DIY projects for toddlers."
    },
    1: {
        "title": "Older Parents with Teenagers",
        "messaging": "Focus on products and services that cater to the needs of teenagers and their parents.",
        "channels": "Facebook and LinkedIn.",
        "promotions": "Offers on educational tools, extracurricular activities, or family trips.",
        "content_ideas": "Blog posts or webinars on managing teenage behavior or preparing for college."
    },
    2: {
        "title": "High-Income, Child-Free Couples and Singles",
        "messaging": "Emphasize luxury, exclusivity, and experiences over products.",
        "channels": "Premium platforms like LinkedIn and Instagram.",
        "promotions": "Exclusive membership offers, luxury product lines, or premium service tiers.",
        "content_ideas": "Showcase high-end experiences, such as luxury travel, gourmet food, and exclusive events."
    },
    3: {
        "title": "Older Parents with Larger Families",
        "messaging": "Focus on products and services that cater to the needs of a larger family.",
        "channels": "Facebook, family-oriented community events, or local advertising.",
        "promotions": "Family packs or bulk discounts on essential products.",
        "content_ideas": "Content that promotes family activities and togetherness."
    }
}
...
if input_type == "Use Selected Customer":
    ...
    customer = {
        "Income": st.sidebar.slider("Income", min_value=int(data["Income"].min()), max_value=int(data["Income"].max()), step=1000),
